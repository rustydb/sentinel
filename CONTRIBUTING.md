...
Before writing a single line of code, you **MUST** read the [Project Constitution](docs/CONSITUTION.md). 
...
1. Read the [CONSTITUION.md](./docs/CONSITUTION.md) - it is the absolute source of truth for all conventions.
...
4. **Pull Requests**: Pull Requests should point to `main` and undergo code review against the Constitution.
