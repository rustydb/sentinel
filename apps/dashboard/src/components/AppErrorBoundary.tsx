  ...
  override render() {
    ...
    return (
      <main className="min-h-screen bg-sentinel-canvas px-6 py-10 text-sentinel-ink">
        <section className="mx-auto flex max-w-3xl flex-col gap-5 border-4 border-sentinel-danger bg-white p-8 shadow-[12px_12px_0_0_#111111]">
          <p className="text-xs uppercase tracking-[0.4em] text-sentinel-muted">Telemetry fault</p>
          <h1 className="text-4xl uppercase leading-none text-sentinel-danger">
          ...
          {this.state.message ? (
            <div className="border-2 border-sentinel-ink bg-sentinel-paper p-4">
