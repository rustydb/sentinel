...
- 001-bootstrap-sentinel: Added TypeScript (Bun runtime), Rust (Edition 2021) + React 19, Vite 6, Tailwind CSS 4, Express 5, `sui-indexer-alt-framework`, `diesel`, `@evefrontier/dapp-kit`
